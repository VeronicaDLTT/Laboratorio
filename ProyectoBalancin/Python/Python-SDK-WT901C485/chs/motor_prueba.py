...
def AccelerationCalibration(device):
    ...
    print("Calibracion del Acelerometro completada")
...
def FiledCalibration(device):
    ...
    if input("请分别绕XYZ轴慢速转动一圈，三轴转圈完成后，结束校准（Y/N)？").lower()=="y":
        ...
        print("Calibracion del Campo Magnetico completada")
...
def startRecord():
    ...
    print("Comenzar a guardar datos\n")
...
def onUpdate(deviceModel):
    ...
    #print("Chiptime:" + str(deviceModel.getDeviceData("Chiptime"))
     #    , "\nTemperatura:" + str(deviceModel.getDeviceData("temperature"))
      #   , "\nAceleracion：" + str(deviceModel.getDeviceData("accX")) +","+  str(deviceModel.getDeviceData("accY")) +","+ str(deviceModel.getDeviceData("accZ"))
       #  , "\nVelocidad angular:" + str(deviceModel.getDeviceData("gyroX")) +","+ str(deviceModel.getDeviceData("gyroY")) +","+ str(deviceModel.getDeviceData("gyroZ"))
        # , "\nAngulo:" + str(deviceModel.getDeviceData("angleX")) +","+ str(deviceModel.getDeviceData("angleY")) +","+ str(deviceModel.getDeviceData("angleZ"))
         #, "\nCampo magnetico:" + str(deviceModel.getDeviceData("magX")) +","+ str(deviceModel.getDeviceData("magY"))+","+ str(deviceModel.getDeviceData("magZ"))
         #, "\n")
...
if __name__ == '__main__':
    ...
    #Especificar el Puerto serial
    #device.serialConfig.portName = "COM5"               #设置串口  Set serial port
    ...
    #while 1:
    # for duty in range(1000,1354,1):
       # incremento = (duty - 1000) / 10
       # speed = duty + incremento
        # print("speed: ",duty,speed)
    band = True
