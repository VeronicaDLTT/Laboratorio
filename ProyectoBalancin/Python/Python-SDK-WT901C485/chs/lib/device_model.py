...
class DeviceModel:
    ...
    def openDevice(self):
        ...
        # 先关闭端口 - Cerramos primero el dispositivo
        self.closeDevice()
        try:
            ...
            print("Abrir " + self.serialConfig.portName + self.serialConfig.baud + " fallo")
    ...
    def closeDevice(self):
        ...
        if self.serialPort is not None:
            ...
            # print("端口关闭了")
        self.isOpen = False
        print("El dispositivo esta cerrado")
        # print("设备关闭了")
